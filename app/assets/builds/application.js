(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global, factory) {
        ...
        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init7 = jQuery.fn.init = function(selector, context, root) {
          var match, elem;
          if (!selector) {
            return this;
          }
        ...
        jQuery.extend({
          ...
          dequeue: function(elem, type) {
            type = type || "fx";
            var queue = jQuery.queue(elem, type), startLength = queue.length, fn2 = queue.shift(), hooks2 = jQuery._queueHooks(elem, type), next = function() {
  ...
  // app/javascript/models/Sidebar.js
  var arrow2;
  var sidebar;
  var _cacheDom = () => {
    arrow2 = document.querySelectorAll(".arrow");
  ...
  var Sidebar_default = { init };

  // app/javascript/models/PagesLogin.js
  ...
  // app/javascript/models/PagesLogin.js
  var authenticityToken2;
  var $btnLogin;
  var $email;
  var $password;
  var isLoading = false;
  var _cacheDom2 = function() {
    $btnLogin = document.querySelector("#btn-login");
    $email = document.querySelector("#input-username");
    $password = document.querySelector("#input-password");
  };
  var _bindEvents2 = function() {
    $btnLogin.addEventListener("click", function() {
      const data = {
        username: $email.value,
        password: $password.value,
        authenticity_token: authenticityToken2
      };
      _toggleInput();
  ...
  var init2 = function(config) {
    authenticityToken2 = config.authenticityToken;
    _cacheDom2();
    _bindEvents2();
  };
  var PagesLogin_default = { init: init2 };

  // app/javascript/models/AreaIndex.js
  ...
  var $areaName;
  var $areaShortName;
  var _cacheDom3 = function() {
    $btnNew = (0, import_jquery2.default)("#btn-new");
    $btnSave = (0, import_jquery2.default)("#btn-save");
    $modalNew = new Modal(document.getElementById("modal-new"));
    $areaName = (0, import_jquery2.default)("#area-name");
    $areaShortName = (0, import_jquery2.default)("#area-shortname");
  };
  var _bindEvents3 = function() {
  ...
  var init3 = function(config) {
    authenticityToken = config.authenticityToken;
    _cacheDom3();
    _bindEvents3();
  };
  var AreaIndex_default = { init: init3 };

  // app/javascript/models/ClusterIndex.js
  ...
  var $selectArea;
  var _cacheDom4 = function() {
    $btnNew2 = (0, import_jquery3.default)("#btn-new");
    $clusterName = (0, import_jquery3.default)("#cluster-name");
    $clusterShortName = (0, import_jquery3.default)("#cluster-shortname");
    $selectArea = (0, import_jquery3.default)("#select-area");
    $btnSave2 = (0, import_jquery3.default)("#btn-save");
    $modalNew2 = new Modal(document.getElementById("modal-new"));
  };
  var _bindEvents4 = function() {
  ...
  var init4 = function(config) {
    authenticityToken = config.authenticityToken;
    _cacheDom4();
    _bindEvents4();
  };
  var ClusterIndex_default = { init: init4 };

  // app/javascript/models/BranchIndex.js
  ...
  var $branchShortName;
  var $selectCluster;
  var _cacheDom5 = function() {
    $btnNew3 = (0, import_jquery4.default)("#btn-new");
    $btnSave3 = (0, import_jquery4.default)("#btn-save");
    $branchName = (0, import_jquery4.default)("#branch-name");
    $branchShortName = (0, import_jquery4.default)("#branch-shortname");
    $selectCluster = (0, import_jquery4.default)("#select-cluster");
    $modalNew3 = new Modal(document.getElementById("modal-new"));
  };
  var _bindEvents5 = function() {
    $btnNew3.on("click", function() {
      $modalNew3.show();
    });
  ...
  var init5 = function(config) {
    authenticityToken = config.authenticityToken;
    _cacheDom5();
    _bindEvents5();
  };
  var BranchIndex_default = { init: init5 };

  // app/javascript/models/JobLevel.js
  ...
  var $jobLevelName;
  var $SelectKSO;
  var _cacheDom6 = function() {
    $btnNew4 = (0, import_jquery5.default)("#btn-new");
    $btnSave4 = (0, import_jquery5.default)("#btn-save");
    $jobLevelName = (0, import_jquery5.default)("#job-level-name");
    $SelectKSO = (0, import_jquery5.default)("#select-kso");
    $modalNew4 = new Modal(document.getElementById("modal-new"));
  };
  var _bindEvents6 = function() {
    $btnNew4.on("click", function() {
      $modalNew4.show();
    });
  ...
  var init6 = function(config) {
    authenticityToken = config.authenticityToken;
    _cacheDom6();
    _bindEvents6();
  };
  var JobLevel_default = { init: init6 };

  // app/javascript/packs/application.js
  var hooks = {
    "pages/login": [PagesLogin_default],
    "admin/areas/index": [AreaIndex_default],
    "admin/clusters/index": [ClusterIndex_default],
    "admin/branches/index": [BranchIndex_default],
    "admin/job_levels/index": [JobLevel_default]
  };
  document.addEventListener("DOMContentLoaded", () => {
    const { route, payload } = JSON.parse((0, import_jquery6.default)("meta[name='parameters']").attr("content"));
    const authenticityToken3 = (0, import_jquery6.default)("meta[name='csrf-token']").attr("content");
    const options = { authenticityToken: authenticityToken3, ...payload };
